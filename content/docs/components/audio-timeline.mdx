...
<ComponentPreview name="use-wavesurfe" variant="codesource" />

</Step>

<Step>

Copy `audio-timeline.tsx` into your project.

<ComponentPreview name="audio-timeline" variant="codesource" />
...
```tsx
<AudioTimeline url="/audio/track.mp3" />
```
