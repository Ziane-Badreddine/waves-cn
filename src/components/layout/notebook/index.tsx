...
function DocsNavbar({
  ...
  return (
    ...
    >
      <div
        data-header-body=""
        className="flex border-b px-4 gap-4 h-14 md:px-6"
      >
        <div
          className={cn(
        ...
        >
          ...
          {renderTitleNav(nav, {
            className: cn(
              "inline-flex items-center gap-2.5 font-semibold whitespace-nowrap",
        ...
        {searchToggle.enabled !== false &&
          (searchToggle.components?.lg ? (
            ...
            <LargeSearchToggle
              hideIfDisabled
              className={cn(
                "w-full my-auto max-md:hidden rounded-full! px-4! py-1.25!",
                navMode === "top" ? "rounded-full   ps-2.5" : "",
              )}
            />
          ))}
