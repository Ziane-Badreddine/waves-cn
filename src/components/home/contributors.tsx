        ...
        <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-2 mt-12">
          {contributors.map((contributor, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative bg-linear-to-b  dark:from-neutral-900 from-secondary dark:to-neutral-950 to-white px-6 py-2 overflow-hidden flex flex-col items-center border gap-4 "
